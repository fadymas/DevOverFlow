...
async function RightSideBar() {
  ...
  return (
    <motion.aside
      ...
      className="pt-30 items-stretch flex flex-col px-6 gap-20 right-0  top-0 sticky  min-h-screen max-w-82.5 max-xl:hidden  background-light900_dark200    border-l shadow-[10px_10px_20px_rgba(218,213,213,0.1)] "
    >
